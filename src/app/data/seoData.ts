...
export const SERVICE_SEO_CONTENT: Record<string, SEOSection[]> = {
  "kitchen-remodeling": [
    ...
    },
    {
      ...
      body: "Kitchen remodeling costs vary depending on the size of your kitchen, the scope of work, and the materials you choose. At Franco and Sons Construction LLC, we believe in complete transparency — you'll receive a detailed written estimate before any work begins, with a clear breakdown of all costs. We never use high-pressure sales tactics, and there are never hidden fees or surprise charges. Whether your budget is $15,000 for a focused refresh or $50,000+ for a complete transformation, we'll help you maximize your investment and increase your home's value. Our free cost guide provides additional budgeting guidance to help you plan your project.",
      links: [
  ...
  "ada-accessible-remodeling": [
    ...
    },
    {
      ...
      body: "Many of our ADA-accessible bathroom remodels are for homeowners who want to stay in their homes safely as they age. Franco and Sons Construction LLC helps Lincoln, Rocklin, and Roseville families create bathrooms that support long-term independence without sacrificing style. Our accessible designs maintain a clean, modern aesthetic — with thoughtful touches like built-in niches, decorative tile patterns, and coordinated fixtures that make your bathroom look great while keeping you safe. We treat every client with respect and take the time to understand their specific needs, mobility challenges, and design preferences before creating a custom plan.",
      links: [
  ...
  "home-additions": [
    {
      ...
      body: "When your family needs more space, Franco and Sons Construction LLC builds home additions in Lincoln and throughout Placer County that look like they were always part of your original home. We handle every aspect of the addition process — from architectural planning and permit coordination to foundation work, framing, electrical, plumbing, and finish carpentry. Whether you need an extra bedroom, a family room expansion, a sunroom, an in-law suite, or an ADU (Accessory Dwelling Unit), our team delivers seamless additions that blend with your existing structure and increase your home's value.",
      bullets: [
...
export const LOCATION_SEO_CONTENT: Record<string, SEOSection[]> = {
  lincoln: [
    {
      heading: "Why Lincoln Homeowners Choose Franco and Sons Construction LLC",
      body: "As Lincoln's trusted local contractor, Franco and Sons Construction LLC has been proudly serving this growing community for years. We're based right here in Lincoln, which means faster response times, familiarity with local building codes, and a deep understanding of the architectural styles found throughout Lincoln's diverse neighborhoods — from Sun City Lincoln Hills and Lincoln Crossing to Del Webb and the newer developments along Twelve Bridges. When you hire us, you're hiring your neighbors.",
      bullets: [
  ...
  roseville: [
    {
      ...
      body: "Roseville homeowners trust Franco and Sons Construction LLC for quality remodeling and construction. Whether you're in West Roseville's newer developments, updating a home in established neighborhoods like Woodcreek or Fiddyment Farm, or renovating a property near historic downtown Roseville, we deliver consistent excellence. Our featured kitchen remodel for Steven in Roseville — where we removed walls, opened the layout, and transformed a cramped kitchen into a bright, spacious dream space — is a perfect example of the transformations we deliver throughout the Roseville community.",
      bullets: [
  ...
  about: [
    {
      ...
      body: "Franco and Sons Construction LLC isn't a franchise or a large corporate operation — we're a real family business. Carlos Franco brings over 30 years of hands-on construction experience to every project, and his son Cristian works alongside him as co-owner, managing client relationships, project coordination, and day-to-day operations. When you hire us, Carlos and Cristian are personally on your job site — not subcontractors you've never met. That's the Franco and Sons Construction LLC difference: real accountability, real expertise, and a genuine commitment to doing excellent work for our neighbors.",
      links: [
